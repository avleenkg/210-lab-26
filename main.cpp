...
int main() {
    ...
    for (int simulations = 0; simulations < NUMSIM; simulations++) {
        ...
        while (getline(fin, line)){
            ...
            results[0][1][simulations] += duration_cast<microseconds>(readE- readS).count();
        ...
        results[1][2][simulations] = -1;
        auto sorts = high_resolution_clock::now();
        lists.sort();
        auto sortend = high_resolution_clock::now();
        results[1][1][simulations] += duration_cast<microseconds>(sortend - sorts).count();
        ...
        results[2][0][simulations] += duration_cast<microseconds>(end - start).count();
        ...
        results[2][1][simulations] += duration_cast<microseconds>(end - start).count();
        ...
        results[3][0][simulations] += duration_cast<microseconds>(end - start).count();
        ...
        results[3][1][simulations] += duration_cast<microseconds>(end - start).count();
